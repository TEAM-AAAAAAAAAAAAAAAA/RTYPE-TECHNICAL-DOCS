---
title: src/client/GetWorld.cpp

---

# src/client/GetWorld.cpp
...
|                | Name           |
| -------------- | -------------- |
| using [ecs::component::Animated::AnimFrame](Classes/structecs_1_1component_1_1_animated_1_1_anim_frame.md) | **[AnimFrame](Files/_get_world_8cpp.md#using-animframe)**  |

## Functions

|                | Name           |
| -------------- | -------------- |
| void | **[registerComponents](Files/_get_world_8cpp.md#function-registercomponents)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[addGameSystems](Files/_get_world_8cpp.md#function-addgamesystems)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setGameHUD](Files/_get_world_8cpp.md#function-setgamehud)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setGameParallax](Files/_get_world_8cpp.md#function-setgameparallax)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| [ecs::World](Classes/classecs_1_1_world.md) | **[getGameWorld](Files/_get_world_8cpp.md#function-getgameworld)**(const std::string & port ="8000", const std::string & host ="localhost") |
| void | **[addMenuSystems](Files/_get_world_8cpp.md#function-addmenusystems)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setMainButtons](Files/_get_world_8cpp.md#function-setmainbuttons)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setRoomTexts](Files/_get_world_8cpp.md#function-setroomtexts)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setRoomButtons](Files/_get_world_8cpp.md#function-setroombuttons)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setVolumeButtons](Files/_get_world_8cpp.md#function-setvolumebuttons)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setOptionInterfaceText](Files/_get_world_8cpp.md#function-setoptioninterfacetext)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setOptionInterface](Files/_get_world_8cpp.md#function-setoptioninterface)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setBackgroundTexture](Files/_get_world_8cpp.md#function-setbackgroundtexture)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setRoomPlanet](Files/_get_world_8cpp.md#function-setroomplanet)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| void | **[setMenuBackground](Files/_get_world_8cpp.md#function-setmenubackground)**([ecs::World](Classes/classecs_1_1_world.md) & world) |
| [ecs::World](Classes/classecs_1_1_world.md) | **[getMenuWorld](Files/_get_world_8cpp.md#function-getmenuworld)**() |

## Attributes

|                | Name           |
| -------------- | -------------- |
| const int | **[FRAME_LIMIT](Files/_get_world_8cpp.md#variable-frame-limit)**  |
...
```cpp
static void setOptionInterfaceText(
    ecs::World & world
)
```
...
```cpp
static void setOptionInterface(
    ecs::World & world
)
```
